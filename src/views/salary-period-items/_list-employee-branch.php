                        ...
                        'create' => function ($url, EmployeeBranchUser $model, $key) use ($salaryPeriod) {
                            return $salaryPeriod->canCreateItems() && $model->canCreateSalaryPayment() ? Html::a(Html::tag('span', ' ', ['class' => 'fa fa-plus']) ,
                                ...
                                [
                                    ...
                                    'data-alert-text' => $model->error_msg ?:  Yii::t('app', 'It is not possible to perform this operation'),
                                ]);
                        },
                            ...
                            if ($model->canUpdate()) {
                                ...
                                $items[] = [
                                    ...
                                    'linkOptions' => [
                                        ...
                                        'data-toggle' => 'modal',
                                        'data-target' => '#modal-pjax',
                                        'data-url' => Url::to(['/employee/default/update-user', 'branch_id' => $model->branch_id, 'user_id' => $model->user_id]),
                                        'data-reload-pjax-container' => "p-jax-salary-period-items",
                                    ],
                                ];
                                $items[] = [
