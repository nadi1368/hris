                ...
                [
                    ...
                    'buttons'  => [
                        ...
                        'reject'  => function ($url, $model, $key) {
                            return $model->canChangeStatus(RequestLeave::STATUS_REJECT_ADMIN) ? Html::a('<span class="far fa-times text-danger"></span>',
                                "javascript:void(0)",
                                [
                                    'id'                         => 'reject-leave-btn',
                                    'data-size'                  => 'modal-lg',
                                    ...
                                    'data-toggle'                => 'modal',
                                    'data-target'                => '#modal-pjax',
                                    'data-url'                   => Url::to(['reject', 'id' => $key, 'status' => RequestLeave::STATUS_REJECT_ADMIN]),
                                    'data-reload-pjax-container' => 'p-jax-request-leave',
                                    'disabled'                   => true
                                ]) : '';
                        },
                        ...
                        'confirm' => function ($url, $model, $key) {
                            return $model->canChangeStatus(RequestLeave::STATUS_CONFIRM_ADMIN) ? Html::a('<span class="fa fa-check text-success"></span>', ['confirm', 'id' => $key, 'status' => RequestLeave::STATUS_CONFIRM_ADMIN], [
