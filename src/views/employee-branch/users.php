                        ...
                        'group' => function ($url, EmployeeBranchUser $model, $key) {
                            ...
                            $items[] = [
                                ...
                                'linkOptions' => [
                                    ...
                                    'data-toggle' => 'modal',
                                    'data-target' => '#modal-pjax',
                                    'data-url' => Url::to(['advance-money/create-with-confirm', 'user_id' => $model->user_id]),
                                    'data-action' => 'edit-ipg',
                                    'data-reload-pjax-container' => "pjax-employee-user",
                                ],
                            ];
                            ...
                            $items[] = [
                                ...
                                'url' => ['/mongo/log/view-ajax', 'modelId' => $model->user_id, 'modelClass' => EmployeeBranchUser::OLD_CLASS_NAME],
                                'encode' => false,
                                'linkOptions' => [
