...
class EmployeeRollCallManageController extends Controller
{
    /**
     * {@inheritdoc}
     */
            ...
            'access' => [
                ...
                'rules' =>
                    [
                        [
                            'allow' => true,
                            'roles' => ['EmployeeRollCallManage/view', 'superadmin'],
                            'actions' => ['index']
                        ],
                        [
                            'allow' => true,
                            'roles' => ['EmployeeRollCallManage/actions', 'superadmin'],
                            'actions' => ['upload-csv-monthly', 'upload-csv-daily', 'insert-csv-monthly', 'insert-csv-daily']
                        ],
                        [
                            'allow' => true,
                            'roles' => ['EmployeeRollCallManage/delete', 'superadmin'],
                            'actions' => ['delete-csv-daily']
                        ],
                    ]
            ]
        ];
